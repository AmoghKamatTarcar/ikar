...
MetronicApp.config(['$stateProvider', '$urlRouterProvider', function($stateProvider, $urlRouterProvider) {
    ...
    $stateProvider
        ...
        .state("profile.mdashboard", {
            url: "/mdashboard/:id",
            templateUrl: "views/profile/mdashboard.html  ",
            data: {pageTitle: 'Merchant Profile', pageSubTitle: ' merchant profile dashboard'}
        })
        ...
        .state('complains', {
            ...
            data: {pageTitle: 'Compains', pageSubTitle: 'issues faced by consumers'},
